...
\section{Obtenci\'on de los diccionarios de ataque}
...
\bigskip\bigskip
\begin{lstlisting}[style=mystyle, language=Python, caption=C\'odigo que se ejecuta en cada hilo del ataque, label=attack1][H]
data = (
supabase
.table('passwords')
